"""
Asciimatics Screen (purdy.matics.iscreen.py)
=================================

This module is an Asciimatics code viewer concrete implementation of a Screen.
It is constructed by :class:`purdy.ui.Screen` depending on its factory.
"""
...
class MaticsFrame(Frame):
    def __init__(self, screen):
        super(MaticsFrame, self).__init__(screen, screen.height,
            screen.width, data=form_data, has_shadow=False, name="Matics Form")
